...
//Kieu du lieu lop ngoai cung la 1 object
// console.log(jobSearch.hits) 
//=>hits la 1 array
let {hits}=jobSearch
console.log(hits[0].skills)
console.log(hits[0].jobTitle)
console.log(hits[0].locations)
console.log(hits[0].jobSalary)
console.log(hits[0].jobRequirement)
